...
user1 = User.create(username:"Test11", password:"String")
user2 = User.create(username:"Test22", password:"String2")

robin = user1.guests.create(mailing_title:"Mr. & Mrs. Robert Thomas", first_name: "Robert", last_name: "Thomas",
...
john = user2.guests.create(mailing_title:"Mr. & Mrs. John Smith", first_name: "John", last_name: "Smith",
